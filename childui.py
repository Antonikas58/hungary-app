...
"}")
        ...
        self.label_3 = QtWidgets.QLabel(self.checkInvoiceTab)
        ...
        self.lineEdit_tax_id_check_2 = QtWidgets.QLineEdit(self.checkInvoiceTab)
        self.lineEdit_tax_id_check_2.setMinimumSize(QtCore.QSize(200, 0))
        self.lineEdit_tax_id_check_2.setMaximumSize(QtCore.QSize(400, 16777215))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(14)
        self.lineEdit_tax_id_check_2.setFont(font)
        self.lineEdit_tax_id_check_2.setStyleSheet("QLineEdit\n"
"{\n"
"    background-color: QLinearGradient( x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #4d4d4d, stop: 0 #646464, stop: 1 #5d5d5d);\n"
"    padding: 1px;\n"
"    border-style: solid;\n"
...
"    border-radius: 5;\n"
"}")
        self.lineEdit_tax_id_check_2.setObjectName("lineEdit_tax_id_check_2")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEdit_tax_id_check_2)
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_inv_num_check)
...
"}")
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_inv_num_check)
        ...
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_direction_check)
...
"}")
        ...
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.comboBox_direction_check)
...
"}")
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.pushButton_send_check)
        ...
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.label_result_check)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.label_error_check)
...
"}")
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_inv_num_dat)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_direction_dat)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_resp_dat)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_source_dat)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_trans_dat)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_index_dat)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_reqv_dat)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_inv_save_time_dat)
        ...
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label_tech_user_dat)
...
"}")
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_inv_num_dat)
...
"}")
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.comboBox_direction_dat)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.label_source_dat_2)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.label_tr_id_dat)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.label_index_dat_2)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.label_version_dat)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.label_save_t_dat)
        ...
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.label_tech_usr_dat)
...
"}")
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.pushButton_send_dat)
        ...
        self.lineEdit_tax_id_dat_2 = QtWidgets.QLineEdit(self.getInvoiceDataTab)
        self.lineEdit_tax_id_dat_2.setMaximumSize(QtCore.QSize(400, 16777215))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(14)
        self.lineEdit_tax_id_dat_2.setFont(font)
        self.lineEdit_tax_id_dat_2.setStyleSheet("QLineEdit\n"
"{\n"
"    background-color: QLinearGradient( x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #4d4d4d, stop: 0 #646464, stop: 1 #5d5d5d);\n"
"    padding: 1px;\n"
"    border-style: solid;\n"
...
"    border-radius: 5;\n"
"}")
        self.lineEdit_tax_id_dat_2.setObjectName("lineEdit_tax_id_dat_2")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEdit_tax_id_dat_2)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.label_error_dat)
...
"}")
    ...
    def retranslateUi(self, ChildWindow):
        ...
        self.getTaxpayerTab.setToolTip(_translate("ChildWindow", "<html><head/><body><p><br/></p></body></html>"))
        ...
        self.label_3.setText(_translate("ChildWindow", "Taxpayer ID to check:"))
        self.lineEdit_tax_id_check_2.setToolTip(_translate("ChildWindow", "<html><head/><body><p>taxpayer id for company that you want to check</p></body></html>"))
        ...
        self.label_4.setText(_translate("ChildWindow", "Taxpayer ID to check:"))
        self.lineEdit_tax_id_dat_2.setToolTip(_translate("ChildWindow", "<html><head/><body><p>taxpayer id for company that you want to check</p></body></html>"))
